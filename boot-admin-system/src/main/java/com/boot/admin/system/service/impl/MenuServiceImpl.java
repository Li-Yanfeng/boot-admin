...
import com.boot.admin.system.mapper.MenuMapper;
import com.boot.admin.system.mapper.RoleMapper;
...
import com.boot.admin.system.model.vo.MenuMetaVO;
...
import com.boot.admin.util.enums.MenuType;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
    ...
    public List<MenuDTO> listMenusByUserId(Long userId) {
        ...
        if (SecurityUtils.isAdmin()) {
            return listMenus(new MenuQuery());
        }
        ...
        List<Menu> menus = baseMapper.selectMenuListByRoleIdsAndType(roleIds, 2L);
        return ConvertUtils.convert(menus, MenuDTO.class);
    }
