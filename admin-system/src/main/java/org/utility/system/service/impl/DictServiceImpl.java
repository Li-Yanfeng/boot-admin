...
import org.utility.system.mapper.DictMapper;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements DictService {
    ...
    public Page<DictDTO> listDicts(DictQuery query, Page<Dict> page) {
        Page<DictDTO> dicts = ConvertUtils.convert(baseMapper.selectPage(page, QueryHelp.queryWrapper(query)), DictDTO.class);
