...
import org.utility.mnt.mapper.DeployMapper;
...
import org.utility.mnt.service.*;
...
import org.utility.mnt.util.ScpClientUtils;
import org.utility.mnt.websocket.MsgType;
import org.utility.mnt.websocket.SocketMsg;
import org.utility.mnt.websocket.WebSocketServer;
...
public class DeployServiceImpl extends ServiceImpl<DeployMapper, Deploy> implements DeployService {
    ...
    public List<DeployDTO> listDeploys(DeployQuery query) {
        ...
        for (DeployDTO dd : list) {
            ...
            dd.setDeploys(new HashSet<>(ConvertUtils.convert(serverMapper.selectList(wrapper), ServerDTO.class)));
        }
        return list;
    }
