...
public class CacheConsts {
    ...
    public static final String DICTDEAIL_DICTID = "dictDetail::dictId:";
    public static final String DICTDEAIL_DICTNAME = "dictDetail::name:";
}
